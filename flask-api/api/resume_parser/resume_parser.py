...
class ResumeParser(object):
    def __init__(self, resume):
        ...
        self.__text_raw, self.__page_count = utils.extract_text(self.__resume, os.path.splitext(self.__resume)[1])
    ...
    def __get_basic_details(self):
        ...
        website    = utils.extract_website(self.__text)
        ...
        sections  = utils.extract_sections(self.__text_raw)
        word_count = utils.extract_word_count(self.__text_raw)
        ...
        self.__details['website'] = website
        self.__details['sections'] = sections
        self.__details['page_count'] = self.__page_count
        self.__details['word_count'] = word_count
        try:
